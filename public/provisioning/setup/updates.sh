...
# PHP 8.3
sudo apt-get install -y php8.3 php8.3-fpm php8.3-cli php8.3-redis php8.3-mbstring php8.3-soap php8.3-intl php8.3-zip php8.3-xml php8.3-gd php8.3-opcache php8.3-apcu php8.3-mysql php8.3-curl php8.3-bcmath php8.3-imagick php8.3-imap

# PHP 8.2
sudo apt-get install -y php8.2 php8.2-fpm php8.2-cli php8.2-redis php8.2-mcrypt php8.2-mbstring php8.2-soap php8.2-intl php8.2-zip php8.2-xml php8.2-gd php8.2-opcache php8.2-apcu php8.2-mysql php8.2-curl php8.2-bcmath php8.2-imagick php8.2-imap
